...
function love.update(dt)
    ...
    if ball.x < 0 then
        servingPlayer = 1 
        player0 = player2Score + 1 -- 2. oyuncu sayı almış olur
...
-- BURADA TOPUN SAĞ VE SOL KENARDAN GİTMESİ DURUMUNDA TOPUN TEKRARDAN ESKİ KONUMUNA GELDİĞİ DURUM İŞLENMİŞTİR
-- ANCAK SAYININ ALINMASI HALİNDE HALEN SKOR TABLOSUNA YAZILMAMAKTADIR